...
IAsyncOperation<LampServiceClearLampFaultResult^>^ LampServiceConsumer::ClearLampFaultAsync(_In_ uint32 interfaceMemberLampFaultCode)
{
    return create_async([this, interfaceMemberLampFaultCode]() -> LampServiceClearLampFaultResult^
    {
        ...
        status = static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "u", interfaceMemberLampFaultCode));
        ...
        alljoyn_proxybusobject_getpropertyasync(
            ...
            [](QStatus status, alljoyn_proxybusobject obj, const alljoyn_msgarg value, void* context)
            {
                ...
                if (ER_OK == status)
                {
                    ...
                    status = static_cast<QStatus>(TypeConversionHelpers::GetAllJoynMessageArg(value, "au", &argument));
...
int32 LampServiceConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "org.allseen.LSF.LampService");
