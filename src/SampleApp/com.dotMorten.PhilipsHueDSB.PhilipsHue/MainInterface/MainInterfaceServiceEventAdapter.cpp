...
// Methods
IAsyncOperation<MainInterfaceLinkResult^>^ MainInterfaceServiceEventAdapter::LinkAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new MainInterfaceLinkCalledEventArgs(info);
    LinkCalled(this, args);
    return MainInterfaceLinkCalledEventArgs::GetResultAsync(args);
}
