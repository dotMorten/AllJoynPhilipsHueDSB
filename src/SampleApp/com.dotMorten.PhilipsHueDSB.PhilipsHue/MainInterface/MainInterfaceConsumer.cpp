...
IAsyncOperation<MainInterfaceLinkResult^>^ MainInterfaceConsumer::LinkAsync()
{
    return create_async([this]() -> MainInterfaceLinkResult^
    {
        ...
        if (ER_OK == status)
        {
            status = alljoyn_proxybusobject_methodcall(
                ProxyBusObject,
                "com.dotMorten.PhilipsHueDSB.PhilipsHue.MainInterface",
                "Link",
                inputs,
                argCount,
                message,
...
int32 MainInterfaceConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "com.dotMorten.PhilipsHueDSB.PhilipsHue.MainInterface");
