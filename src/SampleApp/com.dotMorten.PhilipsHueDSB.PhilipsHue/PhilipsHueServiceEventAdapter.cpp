...
// Methods
// Property Reads
IAsyncOperation<PhilipsHueGetIsLinkedResult^>^ PhilipsHueServiceEventAdapter::GetIsLinkedAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new PhilipsHueGetIsLinkedRequestedEventArgs(info);
    GetIsLinkedRequested(this, args);
    return PhilipsHueGetIsLinkedRequestedEventArgs::GetResultAsync(args);
}
