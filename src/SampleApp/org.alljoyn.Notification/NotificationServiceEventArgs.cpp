...
// Methods
// Readable Properties
NotificationGetVersionRequestedEventArgs::NotificationGetVersionRequestedEventArgs(
    _In_ AllJoynMessageInfo^ info)
    : m_raised(false),
    m_completionsRequired(0),
    m_messageInfo(info)
{
	m_result = NotificationGetVersionResult::CreateFailureResult(ER_NOT_IMPLEMENTED);
}

Deferral^ NotificationGetVersionRequestedEventArgs::GetDeferral()
{
    ...
    auto handler = ref new DeferralCompletedHandler(this, &NotificationGetVersionRequestedEventArgs::Complete);
    return ref new Deferral(handler);
}

void NotificationGetVersionRequestedEventArgs::InvokeAllFinished()
{
    bool invokeNeeded;
...
void NotificationGetVersionRequestedEventArgs::Complete()
{
    bool invokeNeeded;
...
void NotificationGetVersionRequestedEventArgs::InvokeCompleteHandler()
{
