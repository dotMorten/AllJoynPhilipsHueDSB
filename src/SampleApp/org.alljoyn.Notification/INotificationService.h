...
public interface class INotificationService
{
public:
    ...
    Windows::Foundation::IAsyncOperation<NotificationGetVersionResult^>^ GetVersionAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
