...
// Methods
// Property Reads
IAsyncOperation<NotificationGetVersionResult^>^ NotificationServiceEventAdapter::GetVersionAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new NotificationGetVersionRequestedEventArgs(info);
    GetVersionRequested(this, args);
    return NotificationGetVersionRequestedEventArgs::GetResultAsync(args);
}
